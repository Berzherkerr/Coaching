...
function Modal({ post, onClose }) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-start justify-center bg-black/80 backdrop-blur-sm px-4 py-10 overflow-y-auto"
...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 overflow-x-hidden">
      <Header />
      <section className="relative z-10 bg-neutral-950 pt-[7.35rem] pb-[4.2rem] px-4 sm:px-8 lg:px-20">
        <div className="max-w-6xl mx-auto">
          <MotionReveal>
            <div className="text-center mb-12">
              <RevealHeading as="h1" mode="word"
          ...
          {loaded && posts.length === 0 && (
            <p className="text-neutral-600 text-center py-16">Henüz yazı yok.</p>
          )}
