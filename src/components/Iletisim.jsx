...
// Instagram – turuncu tek renk
function InstagramBrandIcon({ className = "h-6 w-6" }) {
  return <Instagram className={className} />;
}

// Google – orijinal renkli G
...
function Iletisim() {
  ...
  return (
    <section id="contact" className="bg-neutral-950 py-[5.78rem] px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden md:flex md:flex-row md:space-between md:items-start md:gap-8">
          ...
          <div className="flex flex-col items-center md:items-center text-center md:w-[45%] space-y-6">
            <div className="space-y-4">
              <h3 className="text-xl sm:text-2xl font-semibold text-white tracking-tight">
                7/24 iletişime geçerek bilgi alabilirsiniz.
              </h3>
          ...
          {/* Sağ: Harita */}
          <div className="md:w-[48%] h-[215px] rounded-sm overflow-hidden shadow-md bg-neutral-900 border border-neutral-800">
            <iframe
              title="Konum"
              src={googleMapsUrl}
              width="100%"
        ...
        <div className="md:hidden grid grid-cols-1 gap-12">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <ul className="space-y-2 pt-3 text-neutral-200 text-sm sm:text-base leading-relaxed">
              <li className="flex items-center justify-center gap-2">
          ...
          {/* Harita */}
          <div className="h-[256px] rounded-sm overflow-hidden shadow-md bg-neutral-900 border border-neutral-800">
            <iframe
              title="Konum"
              src={googleMapsUrl}
              width="100%"
