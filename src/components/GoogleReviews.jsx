...
function GoogleG({ className = "h-5 w-5" }) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden>
      <path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303C33.782 31.662 29.389 35 24 35 16.82 35 11 29.18 11 22S16.82 9 24 9c3.59 0 6.85 1.353 9.354 3.566l5.657-5.657C35.995 3.262 30.268 1 24 1 10.745 1 0 11.745 0 25s10.745 24 24 24c12.426 0 23-9.045 23-24 0-1.585-.169-3.123-.389-4.917z"/>
      <path fill="#FF3D00" d="M6.306 14.691l6.571 4.818C14.694 16.179 19.01 13 24 13c3.59 0 6.85 1.353 9.354 3.566l5.657-5.657C35.995 3.262 30.268 1 24 1 15.34 1 7.865 5.694 4.007 12.59l2.299 2.101z"/>
      <path fill="#4CAF50" d="M24 49c6.16 0 11.75-2.35 15.8-6.2l-6.88-5.63C30.505 39.587 27.42 41 24 41 18.658 41 14.037 37.387 12.31 32.5l-6.7 5.17C8.4 44.76 15.66 49 24 49z"/>
      <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-1.631 3.662-5.245 7-11.303 7-5.99 0-11.306-3.179-11.123-9.509l-6.571 4.818C7.865 38.306 15.34 43 24 43c12.426 0 23-9.045 23-24 0-1.585-.169-3.123-.389-4.917z"/>
    </svg>
  );
}
